...
class BlueBlob(Blob):
    ...
    def __add__(self, other_blob):
        if other_blob.color == (255, 0, 0):  # Red blob
            self.size -= other_blob.size  # self is the blue blob
            other_blob.size -= self.size

        elif other_blob.color == (0, 255, 0):  # Green blob
...
def handle_collisions(blob_list):  # Reminder : blob_list = [blue_blobs, red_blobs, green_blobs]
